package com.matrix.applock.ui.permissiondialog.analytics
...
object PermissionDialogAnayltics {
    ...
    fun usagePermissionPermitClicked(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_USAGE_PERMISSION_PERMIT, Bundle().apply {
    ...
    fun usagePermissionCancelClicked(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_USAGE_PERMISSION_CANCEL, Bundle().apply {
