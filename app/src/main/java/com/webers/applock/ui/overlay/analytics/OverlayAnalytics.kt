package com.webers.applock.ui.overlay.analytics
...
object OverlayAnalytics {
    ...
    fun sendIntrudersPhotoTakenEvent(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_INTRUDERS_CATCHED, Bundle().apply {
    ...
    fun sendIntrudersCameraFailedEvent(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_INTRUDERS_CAMERA_FAILED, Bundle().apply {
