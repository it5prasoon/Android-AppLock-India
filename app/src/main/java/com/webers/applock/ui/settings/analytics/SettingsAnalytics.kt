package com.webers.applock.ui.settings.analytics
...
object SettingsAnalytics {
    ...
    fun fingerPrintEnabled(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_FINGERPRINT_ENABLED, Bundle().apply {
    ...
    fun intrudersEnabled(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_INTRUDERS_ENABLED, Bundle().apply {
    ...
    fun intrudersFolderClicked(context: Context) {
        FirebaseAnalytics.getInstance(context)
            .logEvent(EVENT_NAME_INTRUDERS_FOLDER_CLICKED, Bundle().apply {
