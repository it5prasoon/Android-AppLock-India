...
import com.webers.applock.databinding.ItemVaultListBinding
...
class VaultListAdapter : RecyclerView.Adapter<VaultListAdapter.VaultListItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: VaultListItemViewHolder, position: Int) =
        holder.bind(vaultList[position])
