package com.webers.applock.ui.browser
...
import com.webers.applock.databinding.ActivityBrowserBinding
import com.webers.applock.ui.browser.analytics.BrowserAnalytics
import com.webers.applock.ui.browser.bookmarks.BookmarksDialog
import com.webers.applock.ui.browser.resolver.UrlResolver.FACEBOOK
import com.webers.applock.ui.browser.resolver.UrlResolver.INSTAGRAM
import com.webers.applock.ui.browser.resolver.UrlResolver.TWITTER
import com.webers.applock.ui.browser.resolver.UrlResolver.YOUTUBE
import com.webers.applock.util.extensions.hideKeyboard


class BrowserActivity : BaseActivity<BrowserViewModel>(),
    BookmarksDialog.BookmarkItemSelectListener {
